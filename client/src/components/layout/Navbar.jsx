                ...
                <Container className="h-16 flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4 flex-1 justify-end">
                        ...
                        <Link
                            ...
                            className="relative text-ink-text hover:text-ink-white hidden sm:block"
                        >
                        ...
                        <Link to="/cart" aria-label={`Cart, ${count} item${count === 1 ? '' : 's'}`} className="relative text-ink-text hover:text-ink-white">
                    ...
                    {searchOpen && (
                        ...
                        >
                            <Container className="py-4">
                                <form role="search" onSubmit={submitSearch} className="flex flex-col sm:flex-row gap-2 sm:gap-3">
                                    <label htmlFor="site-search-input" className="sr-only-focusable">Search products</label>
                                    <input
                                        ref={searchInputRef}
